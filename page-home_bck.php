...
?>
    ...
    <span class="sb-close">&nbsp;</span>
      ...
      <div class="share">
        ...
        <a  target="_blank" href="#" onClick="window.open('http://www.facebook.com/sharer/sharer.php?u=http://<?php echo $_SERVER['SERVER_NAME'] .'/' ?>', 'facebook_share', 'height=320, width=640, toolbar=no, menubar=no, scrollbars=no, resizable=no, location=no, directories=no, status=no');" class="fb">facebook</a>
      </div>
</div>
</section><!-- /wrap -->
